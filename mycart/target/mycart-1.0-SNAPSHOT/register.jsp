                ...
                <div class="card">
                    ...
                    <div class="card-body px-5">
                        ...
                        <div class="container text-center">
                            <img src="./img/register_form_logo.png" style="max-width: 100px;" class="img-fluid" alt="">
                        </div>
                        ...
                        <form action="RegisterServlet" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="user_email" type="text" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter here">
                            </div> 
                            <div class="form-group">
